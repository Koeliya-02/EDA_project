...
num_rows <- 20000
# Read the entire CSV
data <- read.csv("train_no_empty_rows.csv",  header = FALSE, stringsAsFactors = FALSE)
...
#View(verify)
nrow(verify)
write.csv(text_data, "train_data_with_sentiments.csv", row.names = FALSE, col.names = TRUE, append = TRUE)
